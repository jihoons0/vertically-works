...
const APPS = [
  {
    ...
    icon: "聖",
    description:
      "A fully vertical, right-to-left scripture reader for Korean, Japanese, and Chinese. Every control, gesture, transition, and reading affordance rethought for the top→bottom, R→L axis.",
    challenges: [
  ...
  },
  {
    ...
    icon: "楽",
    description: null,
    question: "How should playback controls and album art behave in a vertical interface?",
    challenges: [
  ...
  },
  {
    ...
    icon: "語",
    description: null,
    question: "Should chat bubbles stack vertically? Where does the input field belong?",
    challenges: [
      "Chat bubbles traditionally flow vertically — does this align with a vertical writing system?",
      "Input composition for CJK requires a visible IME region",
      "How does the conversation thread orient for RTL reading?",
    ],
  },
  {
    id: "maps",
  ...
  },
  {
    ...
    icon: "読",
    description: null,
    question: "What does a long-form reading application look like when vertical is the primary axis?",
    challenges: [
      "Chapter and section navigation in RTL column order",
      "Annotation and highlight selection across vertical columns",
      "Typography controls (size, spacing) on the vertical axis",
    ],
  },
  {
    id: "notes",
