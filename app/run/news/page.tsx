...
const newsInit = `(function(){try{var e=localStorage.getItem('vn:edition')||'ko';document.documentElement.setAttribute('data-edition',e);if(localStorage.getItem('vn:font')==='sans'){document.documentElement.setAttribute('data-font','sans');}}catch(e){}})();`;
