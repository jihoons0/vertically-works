...
Most questions in vertical interface design do not have correct answers yet. The eight hardest are open as [Discussions](https://github.com/jihoons0/vertically-works/discussions) · motion, mixed-script typography, navigation, text selection, IME, keyboard semantics, drag-and-drop, and what a vertical AI chat interface should be. Strong answers get merged into the spec.
