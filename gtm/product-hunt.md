...
2. **Toggle** close-up (`toggle.gif`) with a one-line caption "thumb travels the reading axis · up is on"
3. **Vertically News** — the live vertical newspaper (`/images/apps/news-poster.jpg`)
4. **Vertically Verse** — the iOS reader (verse video still)
5. **The install** — a clean shot of `npx verticallyworks add …` + the shadcn command
6. **The challenges** — a frame of the open-questions page ("documented as carefully as the answers")

I can generate slides 1–2 and 5–6 from the site on request; 3 exists; 4 needs a Verse still.

## Topics / tags
`Design Tools` · `Developer Tools` · `Open Source` · `Design` · (`GitHub`)

## Links
Website `https://vertically.works` · GitHub `https://github.com/jihoons0/vertically-works`

## Playbook fit
Slot this into **Phase 3 (earned media, Jul 27–Aug 14)** as the anchor event of that week, right alongside the newsletter submissions — same "catch the stragglers after the organic wave" logic as the paid sponsorship.
