...
import { usePicked, iconButtonText } from "@/components/demos/sampleText";

const ICONS = [
  { id: "next", path: "M12 5v14M5 12l7 7 7-7", title: "Next chapter" },
  { id: "prev", path: "M12 5v14M19 12l-7 7-7-7", title: "Previous chapter" },
  { id: "bookmark", path: "M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z", title: "Bookmark" },
  { id: "search", path: "M21 21l-6-6m2-5a7 7 0 1 1-14 0 7 7 0 0 1 14 0", title: "Search" },
  { id: "settings", path: "M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z", title: "Settings" },
];

export function IconButtonDemo() {
  const labels = usePicked(iconButtonText);
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-8)" }}>
      ...
      <p style={{ fontSize: "0.8125rem", color: "var(--color-fg-subtle)", textAlign: "center", margin: 0, lineHeight: 1.6 }}>
        {labelMode === "vertical" ? `Vertical labels below icons follow the reading axis · ${labels[0]}/${labels[1]} orient naturally.` : "Icon-only requires strong visual metaphors. Directional icons must be designed for the vertical axis."}
      </p>
    </div>
  );
}
