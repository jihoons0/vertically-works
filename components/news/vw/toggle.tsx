    ...
    >
      <span
        ...
        style={{
          ...
          left: 3,
          top: 3,
          // up = on: the thumb rises toward the reading start. Transform, not
          // `top` — layout properties re-layout/repaint on every frame.
          transform: checked ? "translateY(0)" : "translateY(18px)",
          width: 20,
          height: 20,
          borderRadius: "50%",
